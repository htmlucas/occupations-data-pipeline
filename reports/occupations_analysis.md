...
| Métrica | Resultado |
|---|---:|
| Registros sem nome | 0 |

Foi identificado 0 registro com nome de ocupação ausente ou vazio.
...
|---|---:|---:|
| Registros | 2694 | 2694 |
| Códigos CBO distintos | 2694 | 2694 |
...
A análise confirmou que o dataset processado contém 2694 ocupações e que o PostgreSQL possui 2694 de registros.
